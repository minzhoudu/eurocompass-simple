...
export const AdminLogin = () => {
  ...
  return (
    <main className="flex h-screen w-screen items-center justify-center bg-gray-400">
      <div className="flex flex-col gap-5 rounded-xl bg-brand-black-900 p-10 shadow-lg shadow-black">
        ...
        <form onSubmit={handleOnSubmit} className="flex w-96 flex-col gap-5">
          <div>
            ...
            <input
              type="email"
              id="email"
              className="mt-2 w-full rounded-lg px-4 py-2 text-brand-black-900"
              required
            />
          </div>
          ...
          <button
            type="submit"
            className="self-center rounded-md border px-4 py-2 text-white transition-colors hover:bg-white hover:text-brand-black-900"
          >
            Uloguj se
          </button>
        </form>
